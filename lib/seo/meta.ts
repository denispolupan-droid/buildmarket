...
// Одиниці фасовки, які реально є в каталозі. Метри були пропущені, і стрічки
// («…, 120 мм, 10 м» проти «…, 120 мм, 50 м») не склеювались у варіанти: базова
// назва в них лишалась різною, тож на картці не було перемикача фасовок.
// «мм» перед «м» у чергуванні — інакше з «120 мм» відкусилось би тільки «м».
const UNIT_RE = 'мм|мл|кг|л|м|г';
