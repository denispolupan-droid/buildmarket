  ...
  return (
    <>
      ...
      <div style={{ background: 'var(--bg-soft)', minHeight: '100vh' }}>
        {/* Порожня шапка: з'явиться, щойно в сайдбарі оберуть категорію (URL стане
            /shop/{slug} через pushState) — той самий вигляд, що при прямому заході */}
        <CategoryHeader lang="uk" />
        <div style={{ margin: '0 auto', padding: '12px 16px 64px' }} className="mobile-pad">
          ...
          <ShopLoader initialSaleOnly={sale === '1'} initialCategory={category} initialBrand={brand} hideCategoryInfo />
          <CategoryAbout lang="uk" />
        </div>
      </div>
      <Footer />
    </>
