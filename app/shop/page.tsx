...
export async function generateMetadata(
  ...
  return {
    ...
    description: 'Купити будівельну хімію в роздріб: герметики, монтажні піни, клеї, ґрунтовки. Широкий вибір від перевірених виробників. Доставка Новою Поштою і ROZETKA по Україні.',
