...
export default async function NewDocumentPage({ searchParams }: { searchParams: Promise<{ type?: string; from?: string }> }) {
  const { type: initialType, from: returnTo } = await searchParams;
