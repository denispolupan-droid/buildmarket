            ...
            return (
              <div key={order.id} style={{
                ...
                >
                  ...
                  {/* Клієнт / Товар */}
                  <div style={{ flex: 1, minWidth: 0, overflow: 'hidden', maxWidth: 'calc(50% - 230px)' }}>
                ...
                {isExpanded && (
                  <>
                  <div style={{ borderTop: '1px solid var(--border-light)', display: 'grid', gridTemplateColumns: '50% 1fr 200px' }}>
