...
import { ChevronLeft, ChevronRight, Package, Pen, SprayCan, Paintbrush, Nut, FlaskConical, Layers, AlignJustify, Shield, Droplets, Hammer, Grid3x3, CloudRain } from 'lucide-react';
...
export const CAT_ICONS  = [Package, Pen, SprayCan, Paintbrush, FlaskConical, Layers, Nut, AlignJustify];
