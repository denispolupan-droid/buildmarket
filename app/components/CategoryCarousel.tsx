...
import { CAT_COLORS, CAT_ICONS, getCatIcon, getCatColor, catDescription } from '../../lib/category-visuals';
...
export { CAT_COLORS, CAT_ICONS, getCatIcon, getCatColor, catDescription };
