...
//
// Цифри перевізників беремо з lib/site, а не пишемо в тексті: тут стояло
// «понад 6000 відділень» проти 28 000 на головній, і сторінка товару роками
// суперечила решті сайту.
...
const CONTENT = {
  uk: {
    ...
    rows: [
      {
        label: 'Доставка',
        text: `Нова Пошта по всій Україні — Київ, Харків, Дніпро, Одеса, Львів та інші міста: понад ${NP_BRANCHES.toLocaleString('uk-UA')} відділень і поштоматів, доставка 1–2 дні. Або в точки видачі ROZETKA — ${RZ_POINTS} точок у ${RZ_CITIES} містах.`,
      },
      {
        label: 'Відправка',
  ...
  ru: {
    ...
    rows: [
      {
        label: 'Доставка',
        text: `Новая Почта по всей Украине — Киев, Харьков, Днепр, Одесса, Львов и другие города: более ${NP_BRANCHES.toLocaleString('ru-RU')} отделений и почтоматов, доставка 1–2 дня. Или в точки выдачи ROZETKA — ${RZ_POINTS} точек в ${RZ_CITIES} городах.`,
      },
      {
        label: 'Отправка',
