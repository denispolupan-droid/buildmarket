...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://fixline.com.ua/dropship' },
  openGraph: {
    title: 'Дропшипінг будівельної хімії | FIXLINE',
...
const steps = [
  ...
  },
  {
    ...
    text: 'Клієнт замовляє у Вас. Ви оформлюєте замовлення в особистому кабінеті: вказуєте товари, дані клієнта та спосіб оплати — накладений платіж або передплата. Все інше — автоматично.',
  },
  {
    n: '04', icon: Truck,
    title: 'Ми відправляємо та розраховуємось',
    text: 'Ми створюємо ТТН, пакуємо та відправляємо від свого імені. Для накладеного платежу — заробіток нараховується після отримання коштів від НП. Для передплатних замовлень — одразу після відправки.',
  },
];
...
const faq = [
  ...
  },
  {
    ...
    a: 'Два варіанти для Вашого клієнта: 1) Накладений платіж — клієнт оплачує при отриманні у відділенні НП, кошти надходять нам і ми нараховуємо Ваш заробіток на баланс. 2) Передплата — клієнт переказує Вам кошти заздалегідь (Monobank, PrivatBank, картка), Ви оформлюєте замовлення без накладеного платежу, ми відправляємо. У будь-якому випадку Ваша закупочна ціна списується з балансу при оформленні замовлення.',
  },
  {
  ...
  },
  {
    ...
    a: 'Для накладеного платежу: після надходження коштів від НП (зазвичай 3-7 днів після відправки) Ваш заробіток нараховується на баланс. Для передплатних замовлень: заробіток фіксується одразу при оформленні — Ви вже отримали кошти від клієнта. Все відображається в особистому кабінеті.',
  },
  {
        ...
        <div className="page-container" style={{ position: 'relative', zIndex: 1 }}>
          <div className="drop-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0', alignItems: 'stretch' }}>
              {[
                { emoji: '👤', label: 'Ваш клієнт',     sub: 'Замовляє у Вас, сплачує накладеним платежем або передплатою', color: 'rgba(255,255,255,0.08)' },
          ...
          <div style={{ maxWidth: '820px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="drop-rules">
            {[
              ...
              },
              {
                ...
                items: [
                  'Накладений платіж: клієнт сплачує при отриманні, НП переказує кошти нам (3-7 днів)',
                  'Передплата: заробіток фіксується одразу при оформленні відправки',
                  'Ваш заробіток нараховується на баланс',
                  'Все видно в розділі "Мої транзакції"',
                ],
              },
              {
