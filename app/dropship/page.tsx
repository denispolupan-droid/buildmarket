...
const steps = [
  ...
  },
  {
    ...
    text: 'Клієнт замовляє у вас. Ви оформлюєте замовлення в особистому кабінеті: вказуєте товари, дані клієнта та суму накладеного платежу. Все інше — автоматично.',
  },
  {
    n: '04', icon: Truck,
    title: 'Ми відправляємо та розраховуємось',
    text: 'Ми створюємо ТТН, пакуємо та відправляємо від свого імені. Після отримання накладеного платежу клієнтом — нараховуємо ваш заробіток на баланс.',
  },
];
...
const faq = [
  ...
  },
  {
    ...
    a: 'Після підтвердження отримання клієнтом та надходження накладеного платежу (зазвичай 3-7 днів після відправки) ваш заробіток нараховується на баланс. Ви бачите це в особистому кабінеті.',
  },
  {
    q: 'Що відбувається, якщо клієнт не забрав посилку?',
    a: 'Посилка повертається до нас. Вартість зворотньої доставки (~50-70 грн) списується з вашого балансу. Товар повертається до нашого каталогу.',
  },
  {
  ...
  },
  {
    ...
    a: 'Нова Пошта утримує комісію ~2% за переказ накладеного платежу. Ця комісія списується з вашого балансу окремим рядком — все прозоро.',
  },
  {
    q: 'Як передати замовлення, якщо немає своєї системи?',
    a: 'В особистому кабінеті є зручна форма оформлення: вказуєте товари, кількість та дані клієнта — ми все робимо автоматично.',
  },
];
        ...
        <div className="page-container" style={{ position: 'relative', zIndex: 1 }}>
          <div className="drop-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0', alignItems: 'stretch' }}>
              {[
                { emoji: '👤', label: 'Ваш клієнт',     sub: 'Замовляє у вас, сплачує накладений платіж', color: 'rgba(255,255,255,0.08)' },
            ...
            {[
              {
                ...
                items: [
                  ...
                  'Банківський переказ на рахунок',
                  'Баланс має покривати закупочну ціну замовлення',
                  'Без балансу — без замовлення',
                ],
              },
              {
                ...
                items: [
                  'Клієнт отримує товар і сплачує накладений платіж',
                  'НП переказує кошти нам (3-7 днів)',
              ...
              },
              {
                ...
                items: [
                  ...
                  'Вартість зворотньої доставки (~50-70 грн) — з вашого балансу',
