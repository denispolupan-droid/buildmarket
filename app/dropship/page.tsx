...
export const metadata: Metadata = {
  ...
  description: 'Продавайте будівельну хімію без складу. Актуальний прайс, автоматичний обмін замовленнями, готові ТТН Нової Пошти. Дропшиппинг строительной химии — XML/YML прайс, работа по Украине.',
  keywords: ['дропшипінг будівельна хімія', 'дропшиппинг строительная химия', 'продавати без складу', 'продавать без склада', 'XML прайс будівельна хімія', 'дропшип Україна', 'дропшип Украина'],
  alternates: { canonical: 'https://fixline.com.ua/dropship' },
  openGraph: {
    title: 'Дропшипінг будівельної хімії | FIXLINE',
    description: 'Продавайте будівельну хімію без складу. XML/YML прайс-фід, автоматичний обмін замовленнями по Україні.',
