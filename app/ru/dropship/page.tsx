...
export const metadata: Metadata = {
  ...
  description: 'Продавайте строительную химию без склада. Балансовая система, автоматическое оформление заказов, доставка напрямую клиенту от нашего имени. Дропшиппинг строительной химии по Украине.',
