...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/opt`,         lastModified: SITE_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
  ...
  const ruStaticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/ru/opt`,        lastModified: SITE_UPDATED, changeFrequency: 'monthly', priority: 0.3 },
