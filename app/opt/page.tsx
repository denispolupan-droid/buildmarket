...
export const metadata: Metadata = {
  ...
  description: `Оптові закупівлі будівельної хімії: герметики, монтажні піни, клеї, ґрунтовки, гідроізоляція. Оптові ціни в особистому кабінеті, мінімальне замовлення ${WHOLESALE_MIN} грн, доставка Новою поштою по всій Україні.`,
  keywords: [
...
const stats = [
  ...
  { icon: Tags,    stat: `${WHOLESALE_MIN.toLocaleString('uk-UA')} ₴`, label: 'мінімальне замовлення', text: 'Далі — ваша оптова ціна на кожну позицію' },
...
const benefits = [
  ...
  { icon: Truck,       title: 'Доставка по всій Україні',    text: 'Нова Пошта у будь-яке відділення чи поштомат або точка видачі ROZETKA. Відвантажуємо з власного складу.' },
