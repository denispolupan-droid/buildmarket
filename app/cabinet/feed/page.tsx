...
export default async function FeedPage() {
  ...
  return (
    <div style={{ padding: '28px 32px 64px', maxWidth: '760px' }}>
      ...
      {!feedUrl && (
        <div style={{ background: '#FEF3C7', border: '1px solid #FCD34D', borderRadius: '12px', padding: '20px 24px', marginBottom: '20px', fontSize: '14px', color: '#92400E' }}>
          Кабінет ще активується. Спробуйте оновити сторінку через кілька секунд або зверніться до менеджера.
        </div>
      )}
